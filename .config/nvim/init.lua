...
vim.keymap.set("n", "za", "za", { desc = "toggle fold", noremap = true, silent = true })
-- open all folds
...
vim.keymap.set(
	...
	"<leader>v",
	"<cmd>Oil --float<CR>",
	{ desc = "open float file explorer", noremap = true, silent = true }
)

-- diagnostics
vim.keymap.set("n", "<leader>e", vim.diagnostic.open_float, { desc = "show diagnostic", noremap = true, silent = true })
